...
const ERR = {
  ...
  meds: 'רשמו תרופות קבועות, או סמנו ״אין תרופות קבועות״',
  name: 'כתבו שם פרטי ושם משפחה',
  sig: 'חסרה חתימה',
  sigBig: 'קובץ החתימה גדול מדי. נקו את החתימה ונסו שוב.',
  typed: 'יש לאשר שהקלדת השם מהווה חתימה',
  birth: 'תאריך הלידה אינו תקין',
  id: 'יש להקליד 4 ספרות בדיוק',
  server: 'השליחה נכשלה. נסו שוב בעוד רגע.',
} as const;
