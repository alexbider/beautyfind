...
const ERRORS: Record<BuyError, string> = {
  ...
  treatment: 'הטיפול שבחרת כבר לא זמין לשובר. בחרו טיפול אחר או סכום.',
  recipient: 'למי השובר?',
  contact: 'פרטי השליחה למקבל/ת לא תקינים.',
  message: 'הברכה ארוכה מ־140 תווים.',
  date: 'בחרו תאריך שליחה מהיום ועד שנה קדימה.',
  buyer_name: 'מה השם שלך?',
  buyer_phone: 'מספר הטלפון שלך לא תקין.',
  buyer_email: 'כתובת המייל שלך לא תקינה. הקבלה נשלחת אליה.',
