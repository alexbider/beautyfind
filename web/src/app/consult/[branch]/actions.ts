...
const MSG = {
  invalid: 'חלק מהפרטים חסרים או לא תקינים. בדקו את הטופס ונסו שוב.',
  slot_taken: 'המועד שבחרתם נתפס הרגע. בחרו מועד אחר מהרשימה המעודכנת.',
  rate: 'כבר נשלחו מהמספר הזה כמה בקשות היום. הקליניקה תחזור אליכם בנוגע אליהן.',
  not_available: 'הקליניקה לא מקבלת כרגע בקשות ייעוץ אונליין. אפשר לפנות אליה דרך עמוד הפרופיל.',
  server: 'השליחה נכשלה בצד שלנו. הפרטים נשמרו בטופס, נסו שוב בעוד רגע.',
} as const;
