...
export const WHY = [
  ...
  'הזרקה אינה תמיד הפתרון, וייעוץ כנה יכול לחסוך כסף',
] as const;
...
export const FLAGS = [
  {
    ...
    body: 'לא מזריקים בתקופה זו. הרופא/ה יוצר/ת קשר כדי להסביר ולתכנן מועד מתאים.',
  },
  {
    key: 'anticoagulants',
    name: 'נטילת מדללי דם',
    note: 'חשוב לציין בייעוץ איזו תרופה ובאיזה מינון. ההחלטה על התאמה ותזמון בידי הרופא/ה בלבד. אין להפסיק ליטול תרופה בלי התייעצות עם הרופא/ה המטפל/ת.',
...
export function declineMessage(reason: DeclineKey, o: { first: string; doctor: string }) {
  switch (reason) {
    case 'medical':
      return `היי ${o.first}, ${o.doctor} בדק/ה את הבקשה. לפי המידע הרפואי שנמסר, הזרקה אינה בטוחה עבורך כרגע. נשמח להסביר בשיחה, ללא עלות.`;
    case 'scope':
      return `היי ${o.first}, תודה על הפנייה. הטיפול המבוקש אינו ניתן אצלנו, ואנחנו ממליצים לפנות לרופא/ת עור. נשמח לעזור בכל שאלה.`;
    case 'duplicate':
      return `היי ${o.first}, קיבלנו כבר את הבקשה הקודמת, ונחזור עם תשובה בהקדם.`;
  }
}
