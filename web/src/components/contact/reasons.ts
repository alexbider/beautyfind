...
export const REASONS: ReasonInfo[] = [
  ...
  },
  {
    ...
    msgHint: 'ציינו את התחום, את הכתובת ומי אחראי/ת מקצועית על הטיפולים.',
  ...
  },
  {
    ...
    sent: 'קיבלנו את הפנייה. נחזור אליכם בתוך שלושה ימי עסקים, ואם הנתון לא נמצא אצלנו, נאמר לכם זאת.',
  },
];
