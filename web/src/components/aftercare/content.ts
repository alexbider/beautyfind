...
export const AFTERCARE: Record<AftercareKey, AftercareSet> = {
  botox: {
    phases: [
      { key: 'first', name: '4 השעות הראשונות', untilHours: 4, dos: ['להישאר זקופה, לא לשכב', 'לכווץ ולהרפות את אזור הטיפול בעדינות מדי פעם'], donts: ['לגעת, לעסות או ללחוץ על האזור', 'להתכופף ממושכות או להרים משקל', 'איפור על נקודות ההזרקה'] },
    ...
    after: 'השאירי הודעה בוואטסאפ ונחזור אלייך.',
  ...
  laser: {
    ...
    after: 'שלחי תמונה בוואטסאפ ונחזור בבוקר.',
